    ...
    <div class="child">
            ...
            <div class="container container--lg worksMainVisual__inner">
                <div class="worksMainVisual__contents">
                    ...
                    <dl v-if="work.release" class="worksMainVisual__item">
                        ...
                        <dd>
                            <time datetime="work.release" v-text="$dateFns.format(new Date(work.release), 'yyyy.MM.dd')">{{ work.release }}</time>
                        </dd>
                    </dl>
                    <dl v-if="work.term" class="worksMainVisual__item">
                        <dt class="worksMainVisual__itemName">製作期間</dt>
                        <dd>{{work.term}}}</dd>
                    </dl>
        ...
        <div class="container">
            <dl class="worksItem">
                ...
                <a href="work.url" target="_blank">{{ works.url }}</a>
                </dd>
            </dl>
        ...
        <p class="button-area">
            <nuxt-link to="/works" class="buttonPrimary buttonPrimary--leftArrow">back</nuxt-link>
        </p>
    </div>
</template>
...
<script>
export default{
  async asyncData({$microcms, param}){
